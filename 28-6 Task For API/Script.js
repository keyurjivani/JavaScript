...
const Ui = (data) =>{
    ...
    data.map((ele)=>{
        ...
        console.log(ele.description.length);
        if(ele.description.length > 60){
            let string =""
            for (let i = 0; i < 60; i++) {
                string += ele.description[i]                
            }
            string+="..."
        Des.innerHTML = string
        ...
        div.append(image,Title,Price,Category,div2,Des,div3)
