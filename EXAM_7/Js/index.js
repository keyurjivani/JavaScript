...
document
  .getElementById("L_T_h")
  .addEventListener("click", () => handleSort("L_T_h"));
document
  .getElementById("H_T_L")
  .addEventListener("click", () => handleSort("H_T_L"));

document
  .getElementById("Low_Like")
  .addEventListener("click", () => handleLikesort("Low_Like"));
document
  .getElementById("High_Like")
  .addEventListener("click", () => handleLikesort("High_Like"));
